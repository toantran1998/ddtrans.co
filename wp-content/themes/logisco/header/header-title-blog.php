<?php
	...
	if( empty($post_option['blog-top-bottom-gradient']) || $post_option['blog-top-bottom-gradient'] == 'default' ){
		$header_gradient = logisco_get_option('general', 'default-blog-top-bottom-gradient', 'enable');
	}else{
	...
	if( $title_style != 'none' && $title_style != 'inside-content' ){	
		...
		$extra_class = ' logisco-style-' . $title_style;
		...
		if( $feature_image_pos == 'title-background' ){
			...
			$extra_class .= ' logisco-feature-image';
		...
		echo '<div class="logisco-blog-title-wrap ' . esc_attr($extra_class) . '" ' . gdlr_core_esc_style(array(
		...
		if( $header_gradient == 'enable' || $header_gradient == 'top' ){  
			echo '<div class="logisco-blog-title-top-overlay" ></div>';
		}
		echo '<div class="logisco-blog-title-overlay" ' . gdlr_core_esc_style(array(
		...
		if( $header_gradient == 'enable' || $header_gradient == 'bottom' ){  
			echo '<div class="logisco-blog-title-bottom-overlay" ></div>';
		}
		echo '<div class="logisco-blog-title-container logisco-container" >';
		echo '<div class="logisco-blog-title-content logisco-item-pdlr" ' . gdlr_core_esc_style(array(
		...
		echo '</div>'; // logisco-page-title-content
		echo '</div>'; // logisco-page-title-container
		echo '</div>'; // logisco-page-title-wrap

		// breadcrumbs
		if( function_exists('bcn_display') ){
			echo '<div class="logisco-breadcrumbs" >';
			echo '<div class="logisco-breadcrumbs-container logisco-container" >';
			echo '<div class="logisco-breadcrumbs-item logisco-item-pdlr" >';
       		bcn_display();
       		echo '</div>';
       		echo '</div>';
       		echo '</div>';
