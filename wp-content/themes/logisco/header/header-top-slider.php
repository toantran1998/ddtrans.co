<?php
	...
	echo '<div class="logisco-above-navigation-slider" >';
	if( $post_option['header-slider'] == 'layer-slider' ){
		...
		if( class_exists('RevSliderSlider') ){
			...
			if( !empty($rev_slider[$post_option['revolution-slider-id']]) ){
				...
				echo '<p class="studiox-center-align" >' . esc_html__('Please import and select the slides you want to show at the header area from the "page options" area again.', 'logisco') . '</p>';
			}
		}
	}
	echo '</div>';