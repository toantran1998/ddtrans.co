<?php
	...
	foreach( $social_list as $social_key => $social_icon ){
		$social_link = logisco_get_option('general', 'top-bar-social-' . $social_key);
		...
		if( !empty($social_link) ){
			echo '<a href="' . esc_attr($social_link) . '" target="_blank" class="logisco-top-bar-social-icon" title="' . esc_attr($social_key) . '" >';
