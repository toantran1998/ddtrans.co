 ...
 */
	...
	$sidebar_type = logisco_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = logisco_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = logisco_get_option('general', 'woocommerce-archive-sidebar-right');		
