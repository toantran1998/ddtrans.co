...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta">
		<em class="woocommerce-review__awaiting-approval">
			<?php esc_html_e( 'Your review is awaiting approval', 'logisco' ); ?>
		</em>
	</p>
...
<?php } else { ?>
	...
	<p class="meta">
		<strong class="woocommerce-review__author logisco-title-font"><?php comment_author(); ?> </strong>
		<?php
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'logisco' ) . ')</em> ';
		}
