<?php
	...
	add_filter('revslider_getUsedFonts', 'logisco_revslider_getUsedFonts');
	if( !function_exists('logisco_revslider_getUsedFonts') ){
		function logisco_revslider_getUsedFonts( $used_font ){
