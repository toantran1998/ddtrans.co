					...
					'settings' => array(
						...
						'options' => array(
							...
							'portfolio-modern2-with-space' => array(
								'title' => esc_html__('Portfolio Modern 2 With Space', 'goodlayers-core-portfolio'),
								'type' => 'checkbox',
								'default' => 'enable'
							),
							...
							'hover' => array(
								...
								'default' => 'title-icon',
								'max-width' => '100px',
								'condition' => array( 'portfolio-style' => array('modern', 'modern-no-space', 'grid', 'grid3', 'grid-no-space', 'fixed-metro', 'metro', 'metro-no-space', 'medium', 'medium-feature') ),
								'wrapper-class' => 'gdlr-core-fullsize'
							),
							'column-size' => array(
								...
								'default' => 20,
								'condition' => array( 'portfolio-style' => array('modern', 'modern-no-space', 'modern2', 'grid', 'grid2', 'grid3', 'grid-no-space', 'modern-desc', 'modern-desc-no-space', 'metro', 'metro-no-space') )
							),
							...
							'layout' => array(
								...
								'default' => 'fitrows',
								'condition' => array( 'portfolio-style' => array('modern', 'modern-no-space', 'modern2', 'grid', 'grid2', 'grid3', 'grid-no-space', 'modern-desc', 'modern-desc-no-space', 'medium', 'medium-feature') )
							),
							...
							'carousel-autoslide' => array(
								...
								'type' => 'checkbox',
								'default' => 'enable',
								'condition' => array( 'portfolio-style' => array('modern', 'modern-no-space', 'modern2', 'grid', 'grid2', 'grid3', 'grid-no-space', 'modern-desc', 'modern-desc-no-space', 'medium', 'medium-feature'), 'layout' => 'carousel' )
							),
	...
	jQuery(window).load(function(){
		setTimeout(function(){
			...
			static function get_content( $settings = array(), $preview = false ){
				...
				if( in_array($settings['portfolio-style'], array('modern', 'modern-no-space', 'modern2', 'grid', 'grid2', 'grid3', 'grid-no-space', 'modern-desc', 'modern-desc-no-space')) ){
					$settings['has-column'] = 'yes';

					if( $settings['portfolio-style'] == 'modern2' ){
