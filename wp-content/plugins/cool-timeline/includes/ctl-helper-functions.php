...
function ctl_custom_style()
{
            ...
            $post_title_text_style =isset( $ctl_options_arr['post_title_text_style'])?$ctl_options_arr['post_title_text_style']:'';
...
border-left-color:transparent;}
 ...
 $final_css=clt_minify_css($styles);
 wp_add_inline_style( 'ctl-styles',$custom_css.' '.$final_css);
