                ...
                },
                {
					...
					onclick: function() {
						editor.windowManager.open( {
							...
							onsubmit: function( e ) {
								editor.insertContent( '[cool-timeline layout="horizontal"  show-posts="' + e.data.number_of_posts + '"   date-format="' + e.data.date_format + '" icons="' + e.data.ctl_icons + '" order="' + e.data.stories_order + '" story-content="'+ e.data.story_content +'"]');
							}
						});
					}
                }
