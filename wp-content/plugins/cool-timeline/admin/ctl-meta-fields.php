<?php 
       ...
       function clt_meta_boxes() {
            ...
            $story_meta->addDate('ctl_story_date',
             array('name' =>__('Story Date / Year <span class="ctl_required">*</span>','cool-timeline'),
            ...
            'desc' =>'<div class="desc-field"><strong style="width: 100%;display: inline-block;margin-top: 40px;">Premium Settings | <a target="_blank" href="https://1.envato.market/ct">Buy Pro</a></strong><img src="https://res.cloudinary.com/pinkborder/image/upload/v1556354078/cool-timeline-pro-wp-plugin/timeline-premium-features.png" style="max-width: 100%;border: 2px solid #ef2e2e;"></div>',
