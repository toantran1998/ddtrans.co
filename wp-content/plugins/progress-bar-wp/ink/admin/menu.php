...
class progressbar_wp {
	...
	text-decoration:none;
		...
		margin-right:10px;	
			...
			<ul class="pro-list">
				<li> <i class="fa fa-check"></i> 32+ Pre Design Templates </li>
				<li> <i class="fa fa-check"></i> Half Circular Pie Layout</li>
				<li> <i class="fa fa-check"></i> Full Circle Layout</li>
				<li> <i class="fa fa-check"></i> Gage Layout</li>
				<li> <i class="fa fa-check"></i> Individual Color</li>
				<li> <i class="fa fa-check"></i> Advanced Animation </li>
				<li> <i class="fa fa-check"></i> Skin Builder</li>
				<li><i class="fa fa-check"></i> 4+ Column Layout</li>
				<li> <i class="fa fa-check"></i> Widget Integrated </li>
				<li> <i class="fa fa-check"></i> Add Unlimited</li>								
				<li> <i class="fa fa-check"></i> 500+ Google Fonts </li>
				<li> <i class="fa fa-check"></i> Color Customization </li>
				...
				<li> <i class="fa fa-check"></i> Gutenberg Compatible </li>	
				<li> <i class="fa fa-check"></i> High Priority Support </li>	
			</ul>
			<div class="pro-button-div">
				<a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/progress-bar-pro/" target="_blank">Check Pro Version</a><a class="btn btn-success btn-lg " href="http://demo.wpshopmart.com/progress-bar-pro-demo/" target="_blank">Check Pro Demo</a>
			</div>				
		<?php
	}
